...
from .views import demo_cron,BrokerMeView, LoginView, RegisterView,BrokerViewSet,ForgotPasswordView, PropertyViewSet, MediaViewSet, ClientViewSet
...
urlpatterns = [
    ...
    path("run-cron/", demo_cron, name="run_demo_cron"),
]